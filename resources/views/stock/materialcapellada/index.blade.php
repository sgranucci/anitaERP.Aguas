    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Materiales de Capelladas</h3>
                <div class="card-tools">
                    <a href="{{route('crear_materialcapellada')}}" class="btn btn-outline-secondary btn-sm">
                       	@if (can('crear-capelladas', false))
