...
class ConsumoOtExport implements FromView, WithColumnFormatting, WithMapping, ShouldAutoSize, WithStyles, WithColumnWidths, WithEvents, WithTitle
{
	use Exportable;
	...
	public function view(): View
	{
        ...
        $data = $this->ordentrabajoService->generaDatosRepConsumoOT($this->desdeFecha, 
                                                    $this->hastaFecha, 
                                                    $this->ordenesTrabajo
                                                    );
        
        return view('exports.produccion.reporteconsumoot.reporteconsumoot', [
                        'datacapellada' => $data['datacapellada'],
                        'dataavio' => $data['dataavio'],
