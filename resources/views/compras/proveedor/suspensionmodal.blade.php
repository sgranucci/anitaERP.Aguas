  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Suspensi&oacute;n del Proveedor</h5>
        ...
        <form>
    		<div class="form-group row">
        		...
        		<select name="modaltiposuspension_id" id="modaltiposuspension_id" data-placeholder="Tipo de suspensi&oacute;n" class="col-lg-6 form-control" data-fouc>
        			...
        			@foreach($tiposuspensionproveedor_query as $key => $value)
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="aceptasuspensionModal" class="btn btn-primary">Suspende proveedor</button>
      </div>
    </div>
  </div>
</div>
