        ...
        <div class="card card-danger">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{route('listar_voucher', ['id' => $data->id])}}" class="btn btn-primary btn-sm">
                        <i class="fa fa-fw fa-reply-all"></i> Lista Voucher
                    </a>
                </div>
            </div>
            <form action="{{route('actualizar_voucher', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
