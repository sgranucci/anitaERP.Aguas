        ...
        <div class="card card-info">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('crear_formapago')}}" class="btn btn-outline-secondary btn-sm">
                       	@if (can('crear-formas-de-pago', false))
